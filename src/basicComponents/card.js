    ...
    if (!array.includes(cake)) {
      ...
      return(
          <div key = {cake.id_post} className="card">
            {modalOpen && <Modal setOpenModal={setModalOpen}  cart={cart} setCart={setCart} categorie={cake.categorie} price={cake.prix} image={cake.image} post={cake.id_post}/>}  
            <img className="photo" src={cake.image}/>
            <div className="Titre">
