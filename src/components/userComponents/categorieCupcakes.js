...
function CategorieCupcakes({ data, setData ,cart,setCart,demand}) {
        ...
        <div >
            ...
            <div style={{
                ...
                <div className="localisation_info" >
                    ...
                    <Select label="Forme" options={optionsForme} width="220px" name="pack_ou_unite" data={data} setData={setData} />
...
export default CategorieCupcakes;