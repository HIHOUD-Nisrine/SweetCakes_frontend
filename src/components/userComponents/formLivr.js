                ...
                <form onSubmit={AddDeliveryDemand}>
                    <MainContainer style={{ flex: 2 }}>
                        <InputsContainer style={{ flex: 1 }}>
                            ...
                            <Up style={{ flex: 1 }}>
                                <Input label="Nom Complet" width="300px" name="nom_emetteur" setData={setData} data={data} />
                                <Input label="Téléphone" width="300px" name="telephone_emetteur" setData={setData} data={data} />
                                <Input label="Adresse" width="300px" name="address_emetteur" setData={setData} data={data} />
                                <Select options={Option} label="Ville" width="300px" name="ville_emetteur" setData={setData} data={data} />
                            </Up>
                            <h3>Informations du destinataire</h3>
                            <Middle style={{ flex: 1 }}>
                                <Input label="Nom Complet" width="300px" name="nom_destinataire" setData={setData} data={data} />
                                <Input label="Téléphone" width="300px" name="telephone_destinataire" setData={setData} data={data} />
                                <Input label="Adresse" width="300px" name="address_destinataire" setData={setData} data={data} />
                                <Select options={Option} label="Ville" width="300px" name="ville_destinataire" setData={setData} data={data} />
